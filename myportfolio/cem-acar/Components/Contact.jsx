    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
           ...
           <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <p className="text-zinc-500 mt-6 mb-8 max-w-[50ch] lg:max-w-[30ch] ">
           ...
           <form 
            ...
            className="xl:pl-10 2xl:pl-20" >
               ...
               <input type="hidden" name="access_key" value="6568ba0f-d914-4e99-bac1-9b27388bb317" />
            ...
            <div className="mb-4">
                ...
                autoComplete="email"
                required
                placeholder="cemacar15@gmail.com" 
                className="text-field"
                />
            </div>
       <div className="mb-4">
           ...
           <textarea 
            ...
            id="message"
            required
            className="text-field resize-y min-h-32 max-h-70"
            >
            </textarea>
       </div>
                    <button
